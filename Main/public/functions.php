<?php
    ...
    function update_database($table_name, $column, array $where,  $image_path, $check)
    {
        ...
        $query .= " WHERE ". $where['col_name'] . "=" . $where['col_value'];


        $result = mysqli_query($conn, $query) or die(mysqli_error($conn));


        edit_form($where['col_value'], $column, $image_path, $check);
